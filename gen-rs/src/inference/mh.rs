...
pub fn metropolis_hastings<Args: Copy,Data: Copy,Ret,ProposalArgs: Copy>(
    rng: &mut ThreadRng,
    ...
    let args = trace.args;
    let (discard, weight) = model.update(&mut trace, args, NoChange, fwd_choices);
