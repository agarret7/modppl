...
impl<Args, Data, Ret> Trace<Args, Data, Ret> {
    ...
    pub fn new(args: Args, data: Data, retv: Ret, logjp: Real) -> Self {
        Trace {
            args,
            data,
            retv: Some(retv),
    ...
    pub fn set_retv(&mut self, v: Ret) {
        self.retv = Some(v);
    }
}
...
pub trait GenFn<Args, Data, Ret> {
    ...
    fn generate(&self, args: Args, constraints: Data) -> (Trace<Args, Data, Ret>, Real);
    ...
    ) -> (Trace<Args, Data, Ret>, Data, Real); // Data := backward choices
    ...
    fn propose(&self, args: Args) -> (Data, Real) {
    ...
    fn assess(&self, args: Args, constraints: Data) -> Real {
